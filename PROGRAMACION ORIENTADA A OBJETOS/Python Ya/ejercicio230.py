...
# Disponer un Listbox con una serie de nombres de frutas. Permitir la selección solo de uno de ellos. Cuando se 
# presione un botón recuperar la fruta seleccionada y mostrarla en una Label.
