...
# Confeccionar un programa que tenga solo un menú de opciones que al ser presionado nos muestre un cuadro de mensaje 
# que informe si queremos finalizar la ejecución del programa. Si se presiona "si" se finaliza el programa en caso 
