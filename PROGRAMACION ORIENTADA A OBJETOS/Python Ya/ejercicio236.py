...
# Mostrar dos controles de tipo Radiobutton con las etiquetas "Varón" y "Mujer", cuando se presione un botón 
# actualizar una Label con el Radiobutton seleccionado.
