...
# Disponer un control Checkbutton que muestre el siguiente mensaje: ¿Está de acuerdo con los términos y condiciones?, además 
# agregar un Button desactivo. Cuando se tilde el Checkbutton inmediatamente activar el botón.
