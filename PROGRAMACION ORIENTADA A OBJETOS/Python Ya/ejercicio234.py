...
# Mostrar una ventana y en su interior dos botones y una label utilizando el módulo ttk. La label muestra inicialmente el 
# valor 1. Cada uno de los botones permiten incrementar o decrementar en uno el contenido de la label
